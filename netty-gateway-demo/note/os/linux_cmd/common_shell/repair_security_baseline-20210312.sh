...
# 显示脚本版本更新时间
echo "本次使用的版本更新时间是2021-3-2，增加删除非认定的特权账号的检查和删除。"
echo 
...
uid0 && empty_pass && ssh_protocol_X11Forwarding && profile_check && pass_check && pass_policy && runlevel_check && passfile_check && log_file_check && secure_log_check && echo "Repair done." && echo $date_time > /root/repair_baseline_dir/repairdone
